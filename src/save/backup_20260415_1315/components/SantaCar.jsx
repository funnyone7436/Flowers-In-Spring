      ...
      particlesRef.current.forEach((particle, index) => {
        ...
        if (pState.active) {
          ...
          if (pState.age < LIFETIME) {
            ...
            // =======================================================
            // NEW: DYNAMIC SCALE BASED ON MOTION VALUE
            // =======================================================
            // motionValue increases the size. Change the '2.0' to scale it up/down more!
            const motionBoost = 1.0 + (motionValue * .01); 
            let currentScale = data.baseScale * motionBoost;
